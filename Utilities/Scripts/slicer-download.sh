...
#   slicer-dl.sh -v 4.11.20210226 -d stable -s

# Add BoneTextureExtension to that installation
#   slicer-dl.sh -v 4.11.20210226 -d stable -e BoneTextureExtension

# Do both steps at once
#   slicer-dl.sh -v 4.11.20210226 -d stable -s -e BoneTextureExtension
...
REVISION="${REVISION:-"4.11.20210226"}"
